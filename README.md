...
| ---------- | --------------------------------- | -------------------------- | ------------ | --------------------------------------------- |
| [feat_sequelize](https://github.com/ksh-fthr/express-work/tree/feat_sequelize)     | http://localhost:3000/find?id=[N] | 従業員情報をID指定して取得 | GET          | `Company` DB を対象に処理する                 |
|            | http://localhost:3000/find        | 従業員情報を全件取得       | GET          | 同上                                          |
|            | http://localhost:3000/register    | 従業員情報を登録           | POST         | 同上                                          |
|            | http://localhost:3000/update      | 従業員情報をID指定して更新 | PUT          | 同上                                          |
|            | http://localhost:3000/remove      | 従業員情報をID指定して削除 | DELETE       | 同上                                          |
| [feat_http_method](https://github.com/ksh-fthr/express-work/tree/feat_http_method) | http://localhost:3000/get         | メッセージを全件取得       | GET          | DB は持たず、メモリ上のデータを対象に処理する |
|            | http://localhost:3000/post        | メッセージを登録           | POST         | 同上                                          |
|            | http://localhost:3000/put         | メッセージをID指定して更新 | PUT          | 同上                                          |
|            | http://localhost:3000/delete      | メッセージをID指定して削除 | DELETE       | 同上                                          |
